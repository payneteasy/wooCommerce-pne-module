...
class Customer extends Data
{
    ...
    protected $customerAcceptLanguage;
    protected $customerUserAgent;
    protected $customerLocalTime;
    protected $customerScreenSize;
     ...
     * @return string
     */
    public function getCustomerAcceptLanguage()
    {
        return $this->customerAcceptLanguage;
    }

    /**
     * @param string $customerAcceptLanguage
     */
    public function setCustomerAcceptLanguage($customerAcceptLanguage)
    {
        $this->customerAcceptLanguage = $customerAcceptLanguage;
    }
    ...
    /**
     * @param string $customerLocalTime
     */
    public function setCustomerLocalTime($customerLocalTime)
    {
        $this->customerLocalTime = $customerLocalTime;
    }

    /**
     * @return string
     */
    public function getCustomerScreenSize()
    {
        return $this->customerScreenSize;
    }

    /**
     * @param string $customerScreenSize
     */
    public function setCustomerScreenSize($customerScreenSize)
    {
        $this->customerScreenSize = $customerScreenSize;
    }
