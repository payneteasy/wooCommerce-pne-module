...
class SaleQuery extends PaymentQuery
{
    ...
    (
        ...
        array('merchant_data',          'payment.merchantData',                 false,  Validator::BIG_STRING),
        // special
        array('customer_accept_language', 'payment.customer.customerAcceptLanguage', false,  Validator::LONG_STRING),
        array('customer_user_agent', 'payment.customer.customerUserAgent', false,  Validator::BIG_STRING),
        array('customer_localtime', 'payment.customer.customerLocalTime', false,  Validator::LONG_STRING),
        array('customer_screen_size', 'payment.customer.customerScreenSize', false,  Validator::LONG_STRING)
    );
